<template>
    <div class="mb-4 p-4 bg-white border border-gray-200 flex justify-between items-end">
        <div>          
        ...
        <div class="flex item-center">
          ...
          <svg @click="deletePost(post)" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6 text-red-600 cursor-pointer">
